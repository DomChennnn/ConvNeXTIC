...
ConvNext_lc_bpp = np.array([0.128,0.208,0.318,0.472,0.669,0.922,1.262,1.694])
ConvNext_lc_psnr = np.array([29.03,30.61,32.51,34.01,35.69,37.44,38.99,40.68])
ConvNext_lc_msssim = np.array([0.9308,0.9529,0.9692,0.9786,0.9853,0.9899,0.9928,0.9950])
